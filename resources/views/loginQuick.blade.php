                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="relative mb-4" data-te-input-wrapper-init>
                                            <input type="number" id="ActivityID" name="ActivityID"
                                                class="block px-2.5 pb-1.5 pt-3 w-full text-sm text-white bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                placeholder=" " value="{{ $activityId }}" readonly/>
                                            <label for="ActivityID"
                                                class="absolute text-sm text-white dark:text-gray-400 duration-300 transform -translate-y-3 scale-75 top-1 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 left-1">Activity ID</label>
                                        </div>
                                        <div class="relative mb-4" data-te-input-wrapper-init>
                                            <input type="text" id="UsernameDonor" name="username"
                                        ...
                                        <div class="relative mb-4" data-te-input-wrapper-init>
                                            <input type="password" id="PasswordDonor" name="password"
                                                class="block px-2.5 pb-1.5 pt-3 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                placeholder=" " />
                                        ...
                                        <div class="mb-12 pt-1 pb-1 text-center">
                                            ...
                                            <div class="flex space-x-10">
                                                <a href="/quick/register/{{ $activityId }}">Register</a>
                                                <!-- <p class="font-bold font-sans text-orange-500">|</p>
                                                <a href="/raiser/login"
                                                    class="font-bold font-sans text-orange-500">RAISER</a> -->
                                            </div>
                                        </div>
                                    </form>
                                </div>
