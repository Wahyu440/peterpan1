...
<body>
    <div class="flex h-screen h-14 bg-gradient-to-r from-violet-500 to-violet-800">
        <a href="/admin/raiser" class="py-3 px-5">
                        ...
                        <div class="g-0 lg:flex lg:flex-wrap">
                            <div class="px-4 md:px-0 lg:w-6/12">
                                <div class="md:mx-6 md:p-12">
                                    ...
                                    <br><br>
                                    <form action="{{ route('raiser.storeRaiser') }}" method="POST">
                                        @csrf
                                        @if ($errors->has('UsernameRaiser'))
                                        <div class="alert alert-danger">
                                            <p class="text-xs text-[#FF6969]">{{ $errors->first('UsernameRaiser') }}</p>
                                        </div>
                                        @endif
                                        ...
                                        <div class="flex items-center mb-4">
                                            ...
                                            <label for="Personal"
                                                class="ml-2 text-sm font-medium text-gray-500 dark:text-gray-300">Personal</label>
                                        </div>
                                        <div class="relative mb-4" data-te-input-wrapper-init>
                                        ...
                                        const agencyRaiserInput = document.getElementById('AgencyRaiser');
                                        const departmentInput = document.getElementById('Department');

                                        personalCheckbox.addEventListener('change', function() {
                                            agencyRaiserInput.readOnly = this.checked;
                                            departmentInput.readOnly = this.checked;
                                            if (this.checked) {
                                                agencyRaiserInput.value = '';
