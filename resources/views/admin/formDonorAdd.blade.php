                            ...
                            <div class="px-4 md:px-0 lg:w-6/12">
                                <div class="md:mx-6 md:p-12">
                                    ...
                                    <form action="{{ route('donor.store') }}" method="POST">
                                        @csrf
                                        @if ($errors->has('UsernameDonor'))
                                        <div class="alert alert-danger">
                                            <p class="text-xs text-[#FF6969]">{{ $errors->first('UsernameDonor') }}</p>
                                        </div>
                                        @endif
                                        @if ($errors->has('EmailDonor'))
                                        <div class="alert alert-danger">
                                            <p class="text-xs text-[#FF6969]">{{ $errors->first('EmailDonor') }}</p>
                                        </div>
                                        @endif
