...
<body>
    <div class="flex h-screen h-14 bg-gradient-to-r from-violet-500 to-violet-800">
        <a href="/donor/donation/list" class="py-3 px-5">
                        ...
                        <div class="g-0 lg:flex lg:flex-wrap">
                            <div class="px-4 md:px-0 lg:w-6/12">
                                <div class="md:mx-6 md:p-12">
                                    ...
                                    @endif
                                    <br>
                                    <form action="/donor/donation/payment/{{$donation->id}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="relative mb-4" data-te-input-wrapper-init>
                                            <input type="text" id="DonationID" name="DonationID"
                                                ...
                                                placeholder=" " value="{{$donation->id}}" readonly />
                                            <label for="DonationID"
                                                class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-3 scale-75 top-1 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 left-1">Donation
                                                ID</label>
                                        </div>
                                        <div class="relative mb-4" data-te-input-wrapper-init>
                                            <input type="text" id="Payment" name="Payment"
                                                ...
                                                placeholder=" " />
                                            <label for="Payment"
                                                class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-3 scale-75 top-1 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-3 left-1">Transaction
                                                ID</label>
                                        </div>
